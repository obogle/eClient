...
angular.module('ngIdle.idle', ['ngIdle.keepalive', 'ngIdle.localStorage'])
  .provider('Idle', function() {
    ...
    this.$get = ['$interval', '$log', '$rootScope', '$document', 'Keepalive', 'IdleLocalStorage', '$window', '$location','redirectServices',
      function($interval, $log, $rootScope, $document, Keepalive, LocalStorage, $window, $location, redirectServices) {
        var state = {
          idle: null,
          timeout: null,
          idling: false,
